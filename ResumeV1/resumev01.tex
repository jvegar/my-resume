...
\resumeSubheading
  ...
  {Software Engineer}{Set 2021 - Aactualidad}
  \resumeItemListStart
    \resumeItem{Liderazgo}
      {Planeamiento utilizando metodologías ágiles, daily meetings, tablero Kanban.}   
    \resumeItem{Arquitectura de datos}
      {Modelamiento de base de datos SQL y No-SQL (Postgres, MongoDB)}              
    \resumeItem{Desarrollo de Aplicaciones Web Full Stack}
      {Experiencia de usuario (UX/UI), desarrollo de componentes FrontEnd (JS, React, Angular), desarrollo de componentes servidor (NodeJS, Hapi, NestJS).}
    \resumeItem{DevOps}
      {Manejo de repositorios GIT, uso de contenedores (Docker) y servicios de la nube (AWS).}

  \resumeItemListEnd

  \resumeSubheading
  {Everis}{Lima, Perú}
  {Center Leader Specialist}{Oct 2020 - Ago 2021}
  \resumeItemListStart
    \resumeItem{Liderazgo}
