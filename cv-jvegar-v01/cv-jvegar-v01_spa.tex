...
%-------------------------------------------
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Desarrollo de aplicaciones}
          {Desarrollo de componentes SharePoint 2013 (Webparts, Flujos de Trabajo, TimerJobs, Páginas maestras).}
      \resumeItemListEnd
...
\section{Proyectos}
  \resumeSubHeadingListStart
    \resumeSubItem{Desarrollo de aplicaciones a medida - Acciona}
      {Desarollo de componentes utilizando SharePoint Framework (React, Node JS), Power Platform (Power Apps, Power Automate)}
    \resumeSubItem{Desarrollo de funcionalidades para Intranet  - Red Eléctrica de España}
      {Desarrollo de Webparts, Timer Jobs, Event Recievers para SharePoint 2013/2016}
...
\section{Conocimientos}
  \resumeSubHeadingListStart
      \resumeSubItem{Lenguajes}{: CSharp, Java, Python, Javascript, C++, NodeJS}
      \resumeSubItem{Tecnologías}{: AWS, Azure, SharePoint, SQL Server}      
      \resumeSubItem{Idiomas}{: Inglés Nivel Avanzado}
  \resumeSubHeadingListEnd
